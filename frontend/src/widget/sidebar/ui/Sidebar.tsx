  ...
  return (
    ...
    >
      <div className="flex h-full flex-col bg-[#1E1F22] px-3 py-4">
        <header
          className={`mb-4 flex items-center ${isCollapsed ? "justify-center" : "justify-between gap-3"}`}
        >
          <div
        ...
        <section
          className={`mb-5 flex items-center p-3 transition-all duration-300 ${
        ...
        >
          ...
          <div
            ...
            className={`min-w-0 overflow-hidden transition-all duration-300 ${
              isCollapsed ? "ml-0 max-w-0 opacity-0" : "ml-3 max-w-[170px] opacity-100"
            }`}
          >
